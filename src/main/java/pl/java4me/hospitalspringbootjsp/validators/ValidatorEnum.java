...
public enum ValidatorEnum {
	...
	FIRSTNAME("[a-zA-z]{3,}", "err_code", "User name should contain a minimum o 3 characters, which are letters or numbers"),
	LASTNAME("[a-zA-z]{3,}", "err_code", "User name should contain a minimum o 3 characters, which are letters or numbers"),
//	DATEOFBIRTH("[0-9]{2}-[0-9]{2}-[0-9]{4}","err_code", "Date of birth should look dd-MM-yyyy"),
	...
	PASSWORD("[a-zA-z0-9]{6,}", "err_code", "Password should contain a minimum o 6 characters, which are letters or numbers"),
